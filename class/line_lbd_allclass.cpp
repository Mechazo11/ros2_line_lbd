/*
 * line_detection interface class
 * Author Shichao Yang,2018, Carnegie Mellon University
 * Email: shichaoy@andrew.cmu.edu
 * Modified for ROS2 by Azmyin Md. Kamal
 */

#include "ros2_line_lbd/line_descriptor.hpp"
#include "ros2_line_lbd/line_descriptor/descriptor.hpp"
...
//* 01/17/2024 I highly recommend not using using namespace
using namespace cv;
